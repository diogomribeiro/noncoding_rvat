...
annoFile=$3 # e.g. c22.JAVIERRE.CADD15.annotations
setFile=$4 # e.g. c22.JAVIERRE.CADD15.setlist
maskFile=$5 #e.g. javi.mask
phenoFile=$6 #e.g. regenie_phenotypes_30June2023.txt
covarFile=$7 #e.g. regenie_covariates_30June2023.txt 
outFile=$8 #e.g. regenie_javierre
outFolder=$9 # e.g. :/regenie/step2/JAVIERRE

inputText="-iin=$phenoFile -iin=$covarFile -iin=$pgenPrefix.pgen -iin=$pgenPrefix.pvar -iin=$pgenPrefix.psam -iin=$predFile -iin=$annoFile -iin=$setFile -iin=$maskFile"
...
--anno-file $(basename $annoFile) \
--set-list $(basename $setFile) \
