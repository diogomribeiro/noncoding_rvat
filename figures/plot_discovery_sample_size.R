...
png("~/fig3d_samplesize.png",720,650)

## FDR 5%
nc_fdr5_30k = fread("~/burdenNC/data/results//137k_30k/NC_30k_SKATO_process_FDR0.05.tsv")
nc_fdr5_83k = fread("~/burdenNC/data/results/83k/NC_83k_SKATO_process_FDR0.05.tsv")
nc_fdr5_137k = fread("~/burdenNC/data/results/137k_30k/NC_137k_SKATO_process_FDR0.05.tsv")
nc_fdr5_200k = fread("~/burdenNC/data/results/200k/NC_SKATO_process_FDR0.05.tsv")

cds_fdr5_30k = fread("~/burdenNC/data/results/137k_30k/CDS_30k_SKATO_process_FDR0.05.tsv")
cds_fdr5_83k = fread("~/burdenNC/data/results/83k/CDS_83k_SKATO_process_FDR0.05.tsv")
cds_fdr5_137k = fread("~/burdenNC/data/results/137k_30k/CDS_137k_SKATO_process_FDR0.05.tsv")
cds_fdr5_200k = fread("~/burdenNC/data/results/200k/CDS_SKATO_process_FDR0.05.tsv")
