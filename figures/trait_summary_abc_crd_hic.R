...
png("~/git/noncoding_rvat/figures/png/traits_plot_abc_crd_hic.png",2400,2000)
...
data4 = fread("~/burdenNC/data/results/200k/ABC_SKATO_process_PVAL1e9.tsv")
data5 = fread("~/burdenNC/data/results/200k/CRD_SKATO_process_PVAL1e9.tsv")
data6 = fread("~/burdenNC/data/results/200k/JAVIERRE_SKATO_process_PVAL1e9.tsv")
...
data = unique(rbind(data4,data5,data6))
